...
Public Class Form8
    ...
    Private Sub TextBox30_LostFocus(sender As Object, e As EventArgs) Handles TextBox30.LostFocus
        ...
        sum = Convert.ToInt32(TextBox9.Text) + Convert.ToInt32(TextBox12.Text) + Convert.ToInt32(TextBox15.Text) + Convert.ToInt32(TextBox18.Text) + Convert.ToInt32(TextBox21.Text) + Convert.ToInt32(TextBox24.Text) + Convert.ToInt32(TextBox27.Text)
        TextBox33.Text = sum
        Percentage = (sum / 650) * 100


        t123 = System.Math.Round(Percentage, 2)
        TextBox35.Text = t123
        ...
        TextBox37.Text = pass_class

        If Convert.ToInt16(TextBox9.Text) < 35 Or Convert.ToInt16(TextBox12.Text) < 35 Or Convert.ToInt16(TextBox15.Text) < 35 Or Convert.ToInt16(TextBox18.Text) < 35 Or Convert.ToInt16(TextBox21.Text) < 35 Or Convert.ToInt16(TextBox24.Text) < 35 Or Convert.ToInt16(TextBox27.Text) < 35 Then
            result = "FAILED"
    ...
    Private Sub TextBox37_LostFocus(sender As Object, e As EventArgs)
